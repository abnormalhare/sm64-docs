...
Beta function that spawned the fish when you walked through low water. Ultimately unused and only finds the water floor.
...
Sets the physics of a beta holdable object.
